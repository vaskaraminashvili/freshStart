...
new window.OverlayScrollbars(el, {
    scrollbars: {
        autoHide: 'leave',
        autoHideDelay: 200
    }
                ...
                <div class="d-flex align-items-center">
                    <div class="toggle-icon-wrapper">
                        ...
                        <div class="d-flex align-items-center py-3"><img class="me-2"
                                src="/myCms/assets/img/icons/spot-illustrations/falcon.png" alt="" width="40" /><span
                    ...
                    <div class="navbar-vertical-content scrollbar">
                        <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                            ...
                            <li class="nav-item">
                                ...
                                <!-- parent pages--><a class="nav-link active" href="../pages/starter.html"
                                ...
                                <ul class="nav collapse false" id="components">
                                    ...
                                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#videos"
                                        ...
                                        <ul class="nav collapse false" id="videos">
                                            ...
                                            <li class="nav-item"><a class="nav-link"
                                                    href="../modules/components/videos/plyr.html" aria-expanded="false">
                                                    <div class="d-flex align-items-center"><span
                        ...
                        <div class="settings mb-3">
                            <div class="card alert p-0 shadow-none" role="alert">
                                ...
                                <div class="card-body text-center"><img
                                        src="/myCms/assets/img/icons/spot-illustrations/navbar-vertical.png" alt=""
                                        width="80" />
                                ...
                                <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                                    <div class="scrollbar list py-3" style="max-height: 24rem;">
                                        ...
                                        <h6 class="dropdown-header fw-medium text-uppercase px-card fs--2 pt-0 pb-2">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="file-thumbnail me-2"><img
                                                        ...
                                                        src="/myCms/assets/img/products/3-thumb.png" alt="" /></div>
                                                <div class="flex-1">
                                        ...
                                        <a class="dropdown-item px-card py-2" href="#!">
                                            <div class="d-flex align-items-center">
                                                <div class="file-thumbnail me-2"><img class="img-fluid"
                                                        src="/myCms/assets/img/icons/zip.png" alt="" /></div>
                                                <div class="flex-1">
                                        ...
                                        <h6 class="dropdown-header fw-medium text-uppercase px-card fs--2 pt-0 pb-2">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-l status-online me-2">
                                                    <img class="rounded-circle" src="/myCms/assets/img/team/1.jpg"
                                                        alt="" />
                                        ...
                                        <a class="dropdown-item px-card py-2" href="../pages/user/profile.html">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-l me-2">
                                                    <img class="rounded-circle" src="/myCms/assets/img/team/2.jpg"
                                                        alt="" />
                                        ...
                                        <a class="dropdown-item px-card py-2" href="../pages/user/profile.html">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-l me-2">
                                                    <img class="rounded-circle" src="/myCms/assets/img/team/3.jpg"
                                                        alt="" />
                    ...
                    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
                                                    ...
                                                    <div class="notification-avatar">
                                                        <div class="avatar avatar-2xl me-3">
                                                            <img class="rounded-circle"
                                                                src="/myCms/assets/img/team/1-thumb.png" alt="" />
                                            ...
                                            <div class="list-group-item">
                                                <a class="notification notification-flush" href="#!">
                                                    <div class="notification-avatar">
                                                        <div class="avatar avatar-2xl me-3">
                                                            <img class="rounded-circle"
                                                                src="/myCms/assets/img/icons/weather-sm.jpg" alt="" />
                                                ...
                                                <a class="border-bottom-0 notification-unread  notification notification-flush"
                                                    ...
                                                    <div class="notification-avatar">
                                                        <div class="avatar avatar-xl me-3">
                                                            <img class="rounded-circle"
                                                                src="/myCms/assets/img/logos/oxford.png" alt="" />
                                            ...
                                            <div class="list-group-item">
                                                <a class="border-bottom-0 notification notification-flush" href="#!">
                                                    <div class="notification-avatar">
                                                        <div class="avatar avatar-xl me-3">
                                                            <img class="rounded-circle"
                                                                src="/myCms/assets/img/team/10.jpg" alt="" />
                        ...
                        <li class="nav-item dropdown"><a class="nav-link pe-0" id="navbarDropdownUser" href="#"
                                ...
                                <div class="avatar avatar-xl">
                                    <img class="rounded-circle" src="/myCms/assets/img/team/3-thumb.png" alt="" />
                    ...
                    <div class="card-body overflow-hidden p-lg-6">
                        <div class="row align-items-center">
                            <div class="col-lg-6"><img class="img-fluid"
                                    src="/myCms/assets/img/icons/spot-illustrations/21.png" alt="" /></div>
