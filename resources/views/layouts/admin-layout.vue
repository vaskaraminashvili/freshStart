...
<template>
  ...
  <main class="main" id="top">
    <div class="container-fluid" data-layout="container">
      <nav
        class="navbar navbar-light navbar-vertical navbar-expand-xl navbar-vibrant"
      >
        <div class="d-flex align-items-center">
          ...
          <a class="navbar-brand" href="../index.html">
            <div class="d-flex align-items-center py-3">
              <img
                class="me-2"
                src="/myCms/assets/img/icons/spot-illustrations/falcon.png"
                alt=""
                width="40"
            ...
            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
              ...
              >
                ...
                <ul class="nav collapse false" id="dummy">
                  <li class="nav-item">
                    <Link
                      :href="route('admin.dummies.index')"
                      class="nav-link"
                      aria-expanded="false"
                    >
                      <div class="d-flex align-items-center">
                        <span class="nav-link-text ps-1"> Index </span>
                      </div>
                    </Link>
                    <!-- more inner pages-->
                  </li>
              ...
              <li class="nav-item">
                <!-- label-->
                <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
                  <div class="col-auto navbar-vertical-label">Manage</div>
                  <div class="col ps-0">
                    <hr class="mb-0 navbar-vertical-divider"/>
                  </div>
                </div>
                ...
                <a
                  ...
                  data-bs-toggle="collapse"
                  aria-expanded="false"
                  aria-controls="moduleManager"
                >
                  <div class="d-flex align-items-center">
                    <span class="nav-link-icon">
                      <span class="fas fa-user-cog"></span>
                    </span>
                    <span class="nav-link-text ps-1">Module Manager</span>
                  </div>
                </a>
                <!-- parent pages-->
                ...
                <ul class="nav collapse false" id="moduleManager">
                  <li class="nav-item">
                    ...
                    >
                      <div class="d-flex align-items-center">
                        <span class="nav-link-text ps-1"> Module List </span>
                      </div>
                    </Link>
                    <!-- more inner pages-->
                  </li>
            ...
            <div class="settings mb-3">
              <div class="card alert p-0 shadow-none" role="alert">
                ...
                <div class="card-body text-center">
                  <img
                    src="/myCms/assets/img/icons/spot-illustrations/navbar-vertical.png"
                    alt=""
                    width="80"
                  />
                  <p class="fs--2 mt-2">
                      ...
                      <div class="d-flex align-items-center">
                        <div class="file-thumbnail me-2">
                          <img
                            ...
                            src="/myCms/assets/img/products/3-thumb.png"
                            alt=""
                          />
                        </div>
                        <div class="flex-1">
                    ...
                    <a class="dropdown-item px-card py-2" href="#!">
                      <div class="d-flex align-items-center">
                        <div class="file-thumbnail me-2">
                          <img
                            class="img-fluid"
                            src="/myCms/assets/img/icons/zip.png"
                            alt=""
                          />
                        </div>
                        <div class="flex-1">
                      ...
                      <div class="d-flex align-items-center">
                        <div class="avatar avatar-l status-online me-2">
                          <img
                            ...
                            src="/myCms/assets/img/team/1.jpg"
                            alt=""
                          />
                        </div>
                        <div class="flex-1">
                    ...
                    >
                      <div class="d-flex align-items-center">
                        <div class="avatar avatar-l me-2">
                          <img
                            class="rounded-circle"
                            src="/myCms/assets/img/team/2.jpg"
                            alt=""
                          />
                        </div>
                        <div class="flex-1">
                    ...
                    >
                      <div class="d-flex align-items-center">
                        <div class="avatar avatar-l me-2">
                          <img
                            class="rounded-circle"
                            src="/myCms/assets/img/team/3.jpg"
                            alt=""
                          />
                        </div>
                        <div class="flex-1">
                        ...
                        >
                          <div class="notification-avatar">
                            <div class="avatar avatar-2xl me-3">
                              <img
                                class="rounded-circle"
                                src="/myCms/assets/img/team/1-thumb.png"
                                alt=""
                              />
                            </div>
                          </div>
                        ...
                        <a class="notification notification-flush" href="#!">
                          <div class="notification-avatar">
                            <div class="avatar avatar-2xl me-3">
                              <img
                                class="rounded-circle"
                                src="/myCms/assets/img/icons/weather-sm.jpg"
                                alt=""
                              />
                            </div>
                          </div>
                        ...
                        >
                          <div class="notification-avatar">
                            <div class="avatar avatar-xl me-3">
                              <img
                                class="rounded-circle"
                                src="/myCms/assets/img/logos/oxford.png"
                                alt=""
                              />
                            </div>
                          </div>
                        ...
                        >
                          <div class="notification-avatar">
                            <div class="avatar avatar-xl me-3">
                              <img
                                class="rounded-circle"
                                src="/myCms/assets/img/team/10.jpg"
                                alt=""
                              />
                            </div>
                          </div>
            ...
            <li class="nav-item dropdown">
              ...
              >
                <div class="avatar avatar-xl">
                  <img
                    class="rounded-circle"
                    src="/myCms/assets/img/team/3-thumb.png"
                    alt=""
                  />
                </div>
              </a>
